...
function private.InitializeDigsiteTemplates()
	...
	local DIGSITE_TEMPLATES = {
		...
		["12:0.455916:0.877786"] = {
			-- Ruins of Khintaset Digsite
			mapID = 249, -- Uldum
			raceID = RaceID.ArchRaceTolvir,
		},
		["12:0.546133:0.291234"] = {
			-- Ruins of Lar'donir Digsite
			mapID = 198, -- Mount Hyjal
			raceID = RaceID.ArchRaceNightElf,
		},
		["12:0.463823:0.378463"] = {
			-- Ruins of Ordil'Aran
			mapID = 63, -- Ashenvale
			raceID = RaceID.ArchRaceNightElf,
		},
		["12:0.470426:0.436588"] = {
			-- Ruins of Stardust
			siteID = 173,
			mapID = 63, -- Ashenvale
			raceID = RaceID.ArchRaceNightElf,
		},
		["12:0.481242:0.884512"] = {
			-- Sahket Wastes Digsite
			mapID = 249, -- Uldum
			raceID = RaceID.ArchRaceTolvir,
		},
		["12:0.519775:0.341003"] = {
            siteID = 467, -- Sanctuary of Malorne Digsite
			mapID = 198, -- Mount Hyjal
			raceID = RaceID.ArchRaceNightElf,
		},
		["12:0.439584:0.529238"] = {
			-- Sargeron Digsite
			mapID = 66, -- Desolace
			raceID = RaceID.ArchRaceNightElf,
		},
		["12:0.432328:0.950096"] = {
			-- Schnottz's Landing
			mapID = 249, -- Uldum
			raceID = RaceID.ArchRaceTolvir,
		},
		["12:0.550481:0.333259"] = {
			-- Scorched Plain Digsite
			siteID = 469,
			mapID = 198, -- Mount Hyjal
			raceID = RaceID.ArchRaceNightElf,
		},
		["12:0.483253:0.796590"] = {
			-- Screaming Reaches Fossil Field
			mapID = 78, -- Un'Goro Crater
			raceID = RaceID.ArchRaceFossil,
		},
		["12:0.522410:0.305949"] = {
			-- Shrine of Goldrinn Digsite
			mapID = 198, -- Mount Hyjal
			raceID = RaceID.ArchRaceNightElf,
		},
		["12:0.385969:0.540773"] = {
			-- Slitherblade Shore Digsite
			mapID = 66, -- Desolace
			raceID = RaceID.ArchRaceNightElf,
		},
		["12:0.366268:0.719103"] = {
			-- Solarsal Digsite
			mapID = 69, -- Feralas
			raceID = RaceID.ArchRaceNightElf,
		},
		["12:0.428008:0.746046"] = {
			-- South Isildien Digsite
			mapID = 69, -- Feralas
			raceID = RaceID.ArchRaceNightElf,
		},
		["12:0.545237:0.896740"] = {
			-- Southmoon Ruins Digsite
			mapID = 71, -- Tanaris
			raceID = RaceID.ArchRaceTroll,
		},
		["12:0.454122:0.813384"] = {
			-- Southwind Village Digsite
			mapID = 81, -- Silithus
			raceID = RaceID.ArchRaceNightElf,
		},
		["12:0.522737:0.937379"] = {
			-- Steps of Fate Digsite
			mapID = 249, -- Uldum
			raceID = RaceID.ArchRaceTolvir,
		},
		["12:0.424693:0.399346"] = {
			siteID = 177, -- Stonetalon Peak
			mapID = 65, -- Stonetalon Mountains
			raceID = RaceID.ArchRaceNightElf,
		},
		["12:0.454258:0.899186"] = {
			-- Temple of Uldum Digsite
			mapID = 249, -- Uldum
			raceID = RaceID.ArchRaceTolvir,
		},
		["12:0.482573:0.840286"] = {
			-- Terror Run Fossil Field
			mapID = 78, -- Un'Goro Crater
			raceID = RaceID.ArchRaceFossil,
		},
		["12:0.523063:0.924376"] = {
			-- Tombs of the Precursors Digsite
			mapID = 249, -- Uldum
			raceID = RaceID.ArchRaceTolvir,
		},
		["12:0.480345:0.505719"] = {
			-- Unearthed Grounds
			mapID = 65, -- Stonetalon Mountains
			raceID = RaceID.ArchRaceFossil,
		},
		["12:0.497519:0.784565"] = {
			-- Upper Lakkari Tar Pits
			mapID = 78, -- Un'Goro Crater
			raceID = RaceID.ArchRaceFossil,
		},
		["12:0.427193:0.610638"] = {
			-- Valley of Bones
			mapID = 66, -- Desolace
			raceID = RaceID.ArchRaceFossil,
		},
		["12:0.558606:0.709891"] = {
			-- Wyrmbog Fossil Field
			mapID = 70, -- Dustwallow Marsh
			raceID = RaceID.ArchRaceFossil,
		},
		["12:0.439312:0.359957"] = {
			siteID = 169, -- Zoram Strand Digsite
			mapID = 63, -- Ashenvale
			raceID = RaceID.ArchRaceNightElf,
		},
		["12:0.543117:0.801114"] = {
		...
		["572:0.559725:0.645239"] = {
			siteID = 1756,-- Gloomshade Digsite
			mapID = 539, -- Shadowmoon Valley
			raceID = RaceID.ArchRaceDraenorOrc,
		},
		...
		["572:0.568653:0.746899"] = {
			siteID = 1742, -- Burial Fields Digsite
			mapID = 539, -- Shadowmoon Valley
			raceID = RaceID.ArchRaceDraenorOrc,
		},
		...
		["619:0.543476:0.479594"] = {
			siteID = 2045, -- Digsite: Crimson Thicket
			mapID = 680, -- Suramar
			raceID = RaceID.ArchRaceDemons,
		},
		...
		["619:0.329283:0.547355"] = {
			siteID = 1969,-- Digsite: Llothien Highlands
			mapID = 630, -- Azsuna
			raceID = RaceID.ArchRaceDemons,
		},
		...
		["619:0.442936:0.203692"] = {
			siteID = 1953, -- Digsite: Pinerock Basin
			mapID = 650, -- Highmountain
			raceID = RaceID.ArchRaceHighmountainTauren,
		},
		...
		["619:0.355985:0.475055"] = {
			siteID = 1973, -- Digsite: Rhut'van Passage
			mapID = 630, -- Azsuna
			raceID = RaceID.ArchRaceDemons,
		},
		...
		["619:0.287507:0.534615"] = {
			siteID = 1976,-- Digsite: Timeworn Strand
			mapID = 630, -- Azsuna
			raceID = RaceID.ArchRaceDemons,
		},
		...
		["876:0.500512:0.703405"] = {
			siteID = 2407, -- Digsite: Vigil Hill
			mapID = 895, -- Tiragarde Sound
			raceID = RaceID.ArchRaceDrust,
		},
		["2417"] = {
			siteID = 2417, -- Digsite: Hunter's Run
			mapID = 896, -- Drustvar
			raceID = RaceID.ArchRaceDrust,
		},
		["876:0.577422:0.430672"] = {
			siteID = 2399, -- Digsite: Valley View
			mapID = 895, -- Tiragarde Sound
			raceID = RaceID.ArchRaceDrust,
		},
		...
		-- ----------------------------------------------------------------------------
		["1695"] = {
			siteID = 1695, -- Stonefang Ridge Digsite
			mapID = 525, -- Frostfire Ridge
			raceID = RaceID.ArchRaceDraenorOrc,
		},
		...
		-- ----------------------------------------------------------------------------
		["1986"] = {
			siteID = 1986, -- Digsite: The Ruined Sanctum
			mapID = 630, -- Azsuna
			raceID = RaceID.ArchRaceHighborneNightElves,
		},
		["2037"] = {
			siteID = 2037, -- Digsite: Koralune Fields
			mapID = 680, -- Suramar
			raceID = RaceID.ArchRaceHighborneNightElves,
		},
		["2073"] = {
			siteID = 2073, -- Digsite: Upper Felsoul Hold
			mapID = 680, -- Suramar
			raceID = RaceID.ArchRaceDemons,
		},
		["2077"] = {
			siteID = 2077, -- Digsite: Highmountain Burial Ground
			mapID = 650, -- Highmountain
			raceID = RaceID.ArchRaceHighmountainTauren,
		},
		["2079"] = {
			siteID = 2079, -- Digsite: Path of Huln
			mapID = 650, -- Highmountain
			raceID = RaceID.ArchRaceHighmountainTauren,
		},
		["2081"] = {
			siteID = 2081, -- Digsite: Black Rook Courtyard
			mapID = 641, -- Val'sharah
			raceID = RaceID.ArchRaceHighborneNightElves,
		},
		["2085"] = {
			siteID = 2085, -- Digsite: Gloaming Reef
			mapID = 641, -- Val'sharah
			raceID = RaceID.ArchRaceHighborneNightElves,
		},
